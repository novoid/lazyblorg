...
# Time-stamp: <2014-03-04 13:41:18 karl.voit>
...
- [ ] define tag to mark persistent pages
- [ ] adopt parsing in htmlizer.py
- [ ] test ID-links from temporal and persistent pages
- [ ] add documentation
