...
# Time-stamp: <2015-05-14 20:21:53 vk>
...
- process
  ...
  7. [-] implement tables using pypandoc
  ...
  8. [ ] implement lists using pypandoc
     - don't forget sanitizing
  9. lazyblorg.py
     - [ ] generate_output()
  ...
  10. [ ] implement pypandoc_test.py testcase with all used Org-mode syntax elements
  11. orgparser.py
      - unchanged states
  ...
  12. htmlizer.py -copy-> pandocizer.py (or similar)
  ...
  13. [ ] implement exception handling when pypandoc is not found/installed
