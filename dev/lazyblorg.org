# Time-stamp: <2013-10-01 21:06:11 vk>
# -*- coding: utf-8 -*-
...
** NEXT separate blogdata structures via tags                 :architecture:
:PROPERTIES:
...
:END:
** NEXT adopt method for getting link to any article; get also URL
:PROPERTIES:
:CREATED:  [2013-09-29 Sun 15:01]
:ID: 2013-09-29-get-link
:END:
...
~blog_data~ is a Python dict (each per blog entry type/category) of
Python lists containing one dictionary entry per blog entry:
