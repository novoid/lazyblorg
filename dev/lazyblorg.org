# Time-stamp: <2013-02-12 14:07:39 vk>
# -*- coding: utf-8 -*-
...
NOTE: Issues that are marked as DONE or CANCELED are moved to the
corresponding archive-file "lazyblorg.org_archive".

** NEXT setting up test entry and resulting data                      :tests:
SCHEDULED: <2013-02-12 Tue>
:PROPERTIES:
