...
# Time-stamp: <2016-10-18 18:25:06 vk>
...
*** NEXT implement: add_entry_to_entries_timeline_by_published(entries_timeline_by_published, id)
SCHEDULED: <2016-08-06 Sat>
:PROPERTIES:
...
*** NEXT implement: get_year_of_first_entry(entries_timeline_by_published) + get_year_of_last_entry(entries_timeline_by_published)
:PROPERTIES:
:CREATED:  [2016-02-07 Sun 10:06]
:END:

*** NEXT implement: get_number_of_entries(entries_timeline_by_published, OPTIONAL: year=False, month=False, day=False)
:PROPERTIES:
...
*** NEXT implement: get_entries_of_month(entries_timeline_by_published, year, month)
SCHEDULED: <2016-08-06 Sat>
:PROPERTIES:
...
*** NEXT implement: get_entries_of_day(entries_timeline_by_published, year, month, day)
SCHEDULED: <2016-08-06 Sat>
:PROPERTIES:
:CREATED:  [2016-02-07 Sun 10:16]
:END:
