# Time-stamp: <2013-05-21 15:50:43 vk>
# -*- coding: utf-8 -*-
...
#+BEGIN_SRC python
  ...
  [ {'level': 2,                                                ## number of asterisks
     ...
     'finished-timestamp-history': [1234567, 1234599, 132222],  ## UNIX epoch
     'timestamp': 132222,                                       ## UNIX epoch
#     '': , 
#     '': , 
#     '': , 
     'content': [ ['text', u'This is the Org-mode content'],    ## 'text': anything that is not defined like tables, ...
