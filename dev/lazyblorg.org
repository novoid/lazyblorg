...
# Time-stamp: <2016-11-16 21:31:32 vk>
...
** NEXT link autotag pages to same hidden article (in templates.org)                      :userstory:
:PROPERTIES:
:CREATED:  [2016-11-15 Tue 17:45]
:END:

Until tag pages for autotags are not implemented, link to an hidden Org-mode
entry which is defined in the template file.
