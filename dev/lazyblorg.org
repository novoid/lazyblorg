# Time-stamp: <2013-02-27 15:08:48 vk>
# -*- coding: utf-8 -*-
...
** NEXT spike: calling Org-mode elisp HTML exporter from command line :architecture:
:PROPERTIES:
...
*** STARTED Calling Org-HTML-export in ELISP
