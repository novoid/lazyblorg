...
# Time-stamp: <2015-05-09 12:18:36 vk>
...
- process
  ...
  2. [ ] write unit-test for basic test of pypandoc!
  3. [ ] document pypandoc requirement and its test
  4. [ ] thinking of: keeping parser/htmlizer and using pypandoc only
     for hard to parse/htmlize blocks?
     - [ ] test naïve pypandoc lazyblorg for public-voit before
  5. [ ] data model (file_blog_data)
  ...
  7. orgparser.py
     ...
     - changed states
       ...
       - [ ] TABLE
       - [ ] COLON_BLOCK
     - definitions that need modifications
       - [ ] parse_orgmode_file()
     - [ ] HTML-blocks without title should stay HTML
     - [ ] #+NAME of examples and some other blocks are being ignored by pypandoc
  8. htmlizer.py -copy-> pandocizer.py (or similar)
...
**** NEXT implement: save auto-tag to object
SCHEDULED: <2015-05-09 Sat>
:PROPERTIES:
:CREATED:  [2015-05-06 Wed 11:27]
:END:

**** NEXT implement: display auto-tags (differently)
SCHEDULED: <2015-05-09 Sat>
:PROPERTIES:
:CREATED:  [2015-05-06 Wed 11:27]
:END:
**** NEXT implement: disable language guessing auto-tag using command line argument
:PROPERTIES:
