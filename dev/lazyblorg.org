...
# Time-stamp: <2016-11-16 23:25:28 vk>
...
** NEXT fix paths in preview_blogentry.sh                                                 :userstory:
   :PROPERTIES:
   :CREATED:  [2016-11-16 Wed 23:15]
   :END:
** NEXT write 'test_before_push_to_github.sh'                                          :architecture:
   :PROPERTIES:
   :CREATED:  [2016-11-16 Wed 23:00]
   :END:

- [ ] testall.sh
- [ ] test run with example_invocation.sh
- [ ] xmlint generated feed files
  - xmllint --html --noout ~/public_html/feeds/*links-only.xml

** NEXT example_invocation.sh: move manual_prototype files to e2e-test & remove manual_prototype
   :PROPERTIES:
   :CREATED:  [2016-11-16 Wed 23:18]
   :END:

** NEXT more comments of parameters in 'example_invocation.sh'                            :userstory:
   :PROPERTIES:
   :CREATED:  [2016-11-16 Wed 23:02]
   :END:

** NEXT move references to about page to config.py                                        :userstory:
   :PROPERTIES:
   :CREATED:  [2016-11-16 Wed 23:20]
   :END:

** NEXT move twitter handle to config.py                                                  :userstory:
   :PROPERTIES:
   :CREATED:  [2016-11-16 Wed 23:21]
   :END:

** NEXT move twitter:image to config.py                                                   :userstory:
   :PROPERTIES:
   :CREATED:  [2016-11-16 Wed 23:22]
   :END:

** NEXT move "#BASE-URL#/public_voit.css" to its own variable                             :userstory:
   :PROPERTIES:
   :CREATED:  [2016-11-16 Wed 23:23]
   :END:

** NEXT move publicvoit-comment@Karl-Voit.at to config.py                                 :userstory:
   :PROPERTIES:
   :CREATED:  [2016-11-16 Wed 23:24]
   :END:
