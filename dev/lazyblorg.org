# Time-stamp: <2013-08-20 22:06:13 vk>
# -*- coding: utf-8 -*-
...
- in order not to store *whole* content while parsing, split up parsing
...
** NEXT parse format template file                            :architecture:
:PROPERTIES:
...
| *Org Element*       | *HTML5*           | earmarked | implemented since | low prio |
|---------------------+-------------------+-----------+-------------------+----------|
| bold                | em                |           |                   |          |
| center-block        |                   |           |                   |          |
| clock               |                   |           |                   |          |
...
** DONE [#A] Representation of blog data
