...
# Time-stamp: <2016-10-18 18:55:31 vk>
...
** NEXT [#A] document: what elements are rendered/converted via pypandoc?
...
** NEXT Parser: generate data structure and methods for time-sorted archive [2/8]
:PROPERTIES:
:CREATED:  [2016-02-07 Sun 09:04]
:END:

complete data is dict of year:[list of 12 months]
#+BEGIN_EXAMPLE
	{
	  2008:  [[1:Jan], [2:Feb], [3:Mar], [], [], [], [], [], [], [], [], [12:Dec]]
	  2009:  [[],   [], [], [], [], [], [], [], [], [], [], []]
	  2010:  [[],   [], [], [], [], [], [], [], [], [], [], []]
	  2011:  [[],   [], [], [], [], [], [], [], [], [], [], []]
	  2012:  [[],   [], [], [], [], [], [], [], [], [], [], []]
...
month/[1:Jan] is [list of list of 28-31 days]:
...
:  [id:2008-01-01-happy-new-year-blogpost, id:2008-01-01-this-was-2007, ...]

Example parsing of complete data-set:
...
*** DONE [#A] implement: parsing of entries_timeline_by_published in orgparser
CLOSED: [2016-10-18 Tue 18:06] SCHEDULED: <2016-08-06 Sat>
:PROPERTIES:
:CREATED:  [2016-02-07 Sun 10:41]
:END:
:LOGBOOK:
- State "DONE"       from "STARTED"    [2016-10-18 Tue 18:06]
- Rescheduled from "[2016-02-07 Sun]" on [2016-07-23 Sat 12:19]
:END:

[[file:~/src/lazyblorg/lib/utils.py]] > generate_metadata_from_blogdata(blogdata)

*** DONE implement: get_year_of_first_entry(entries_timeline_by_published) + get_year_of_last_entry(entries_timeline_by_published)
CLOSED: [2016-10-18 Tue 18:24] SCHEDULED: <2016-08-06 Sat>
:PROPERTIES:
:CREATED:  [2016-02-07 Sun 10:06]
:END:
:LOGBOOK:
- State "DONE"       from "NEXT"       [2016-10-18 Tue 18:24]
- Rescheduled from "[2016-02-07 Sun]" on [2016-07-23 Sat 12:19]
:END:

*** DONE implement: get_number_of_entries(entries_timeline_by_published, OPTIONAL: year=False, month=False, day=False)
CLOSED: [2016-10-18 Tue 19:48]
:PROPERTIES:
:CREATED:  [2016-02-07 Sun 10:02]
:END:
:LOGBOOK:
- State "DONE"       from "NEXT"       [2016-10-18 Tue 19:48]
:END:

: get_number_of_entries(entries_timeline_by_published, )             ## 314
: get_number_of_entries(entries_timeline_by_published, 2008)         ## 19
: get_number_of_entries(entries_timeline_by_published, 4444)         ## 0
: get_number_of_entries(entries_timeline_by_published, 2008, 8)      ## 7
: get_number_of_entries(entries_timeline_by_published, 2008, 8, 13)  ## 1

I changed my mind and wrote Utils.get_entries_of_published_date()
which is able to return the *list* of blog entries.

If you want the *number*, do a len() yourself ;-)

*** DONE implement: get_entries_of_month(entries_timeline_by_published, year, month)
CLOSED: [2016-10-18 Tue 19:48] SCHEDULED: <2016-08-06 Sat>
:PROPERTIES:
:CREATED:  [2016-02-07 Sun 10:16]
:END:
:LOGBOOK:
- State "DONE"       from "NEXT"       [2016-10-18 Tue 19:48]
- Rescheduled from "[2016-02-07 Sun]" on [2016-07-23 Sat 12:19]
...
- returns list of days containing list of IDs
...
*** DONE implement: get_entries_of_day(entries_timeline_by_published, year, month, day)
CLOSED: [2016-10-18 Tue 19:48] SCHEDULED: <2016-08-06 Sat>
:PROPERTIES:
:CREATED:  [2016-02-07 Sun 10:16]
:END:
...
*** DONE implement: add_entry_to_entries_timeline_by_published(entries_timeline_by_published, id)
CLOSED: [2016-10-18 Tue 19:48]
:PROPERTIES:
:CREATED:  [2016-10-18 Tue 18:26]
:END:
:LOGBOOK:
- State "DONE"       from "NEXT"       [2016-10-18 Tue 19:48]
- Not scheduled, was "[2016-08-06 Sat]" on [2016-10-18 Tue 18:26]
:END:
:PROPERTIES:
- Rescheduled from "[2016-05-15 Sun]" on [2016-07-10 Sun 20:39]
- Rescheduled from "[2016-05-04 Wed]" on [2016-05-09 Mon 23:34]
- Rescheduled from "[2016-04-16 Sat]" on [2016-04-28 Thu 22:11]
- Rescheduled from "[2016-04-10 Sun]" on [2016-04-10 Sun 20:49]
- Rescheduled from "[2016-04-01 Fri]" on [2016-04-01 Fri 21:37]
- Rescheduled from "[2016-03-25 Fri]" on [2016-03-25 Fri 15:17]
- Rescheduled from "[2016-03-18 Fri]" on [2016-03-20 Sun 09:04]
- Rescheduled from "[2016-03-11 Fri]" on [2016-03-13 Sun 15:02]
- Rescheduled from "[2016-02-27 Sat]" on [2016-02-28 Sun 16:51]
- Rescheduled from "[2016-02-13 Sat]" on [2016-02-13 Sat 18:18]
- Rescheduled from "[2016-02-07 Sun]" on [2016-02-07 Sun 19:49]
:END:

- [[file:~/src/lazyblorg/lib/utils.py]] > generate_metadata_from_blogdata(blogdata)
- see FIXXMEmd

- [X] how to determine the number of days of a month?
  - calendar.monthrange(year, month) -> 0-6 mon-sun + 28-31
...
** NEXT fix Atom-feed (with CDATA for body?)                                           :architecture:
:PROPERTIES:
...
*** Issue reported by Tobias Barthel

#+BEGIN_QUOTE
Ich schaue immer wieder gerne bei dir auf dem Blog vorbei und habe heute
versucht ihn im RSS-Reader Akregator (unter Linux) einzufügen. Dabei mir
ist folgendes aufgefallen:
- der Feed „subscribe content“ ist leer, dafür enthält der andere auch
den Content
- Akregator lässt mich einzelne Artikel nicht ansurfen (Funktion „im
externen Browser öffnen“), wie das bei anderen RSS-Feeds, die ich
abonniert habe, problemlos funktioniert.
#+END_QUOTE

#+BEGIN_QUOTE
Ich meine
http://karl-voit.at/feeds/lazyblorg-all.atom_1.0.links-only.xml. Der
andere hat enthält gar keinen Content, wenn ich ihn im Firefox anzeigen
lasse.

Habe jetzt auch Yarrsr ausprobiert, der lädt beide deiner RSS-Feeds
nicht einmal. Aber das Tool mag ich auch nicht sonderlich.

Für mich sieht das aus, als ob die Reader irgendwelche
Standard-Informationen erwarten und nicht bekommen..
#+END_QUOTE
...
** SOMEDAY implement: auto-tag for short articles                                        :userstory:
:PROPERTIES:
:CREATED:  [2016-02-12 Fri 23:02]
:END:
:LOGBOOK:
- State "SOMEDAY"    from              [2016-02-12 Fri 23:02]
:END:
