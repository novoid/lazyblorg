...
# Time-stamp: <2014-02-01 15:03:08 vk>
...
** NEXT [#A] find out why I took CREATED and not the first DONE time-stamp :architecture:
:PROPERTIES:
...
** NEXT [#A] compare status with published version of meta-data :architecture:
:PROPERTIES:
