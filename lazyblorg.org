...
# Time-stamp: <2017-04-23 16:40:26 vk>
...
** NEXT Blog entries can not start with a list                                                  :bug:
:PROPERTIES:
:CREATED:  [2017-04-23 Sun 12:49]
:END:

- https://github.com/novoid/lazyblorg/issues/10

** NEXT lb-manual on public voit or GitHub Wiki
:PROPERTIES:
:CREATED:  [2017-04-11 Tue 08:12]
:END:

- id:lazyblorg-docu id:lazyblorg-docu-blocks
  id:lazyblorg-docu-how-to-use and so on ...
