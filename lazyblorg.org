...
# Time-stamp: <2017-02-12 13:23:22 vk>
...
** NEXT tag pages: fix dates shown from "CREATED" to first DONE timestamp
:PROPERTIES:
:CREATED:  [2017-02-12 Sun 13:10]
:END:
...
#+BEGIN_SRC python
  ...
  [ {'level': 2,                                                ## number of asterisks
     ...
     'latestupdateTS': datetime,                                    ## most current time-stamp
     'created': datetime,
...
#+BEGIN_EXAMPLE
>>> metadata
{u'2013-08-22-testid': {'title': u"This is the title", 'latestupdateTS': datetime.datetime(2013, 8, 22, 21, 6), 'checksum': 'b757f8478bffd6c70a474f213d6520de', 'created': datetime.datetime(2013, 8, 22, 21, 6)},
