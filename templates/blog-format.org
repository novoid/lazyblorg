## Time-stamp: <2016-11-16 21:40:37 vk>
...
#+BEGIN_EXPORT HTML
  ...
  <link rel="stylesheet" title="#BLOG-NAME# Standard CSS Style"
        href="#BASE-URL#/public_voit.css" type="text/css" media="screen"  />
  ...
  <header class="persistent-header">
      ...
      <nav class="entrypage-article-header-nav">
        <span class="breadcrumbs">
          <img src="#BASE-URL#/images/public-voit_logo.svg" alt="#BLOG-NAME# logo" width="350" style="vertical-align:middle;"><span style="padding-top:1em;">
        </span>
      </nav>
  ...
  <p>
    ...
    On this page you can see the latest blog updates. For further articles, please <b>navigate through the blue tags</b> or use the <b>search bar</b>.

  </p>

  <p>

    I recommend any decent <a href="https://en.wikipedia.org/wiki/RSS">RSS</a>/<a href="https://en.wikipedia.org/wiki/Atom_(standard)">Atom aggregator</a> to follow my blog.

  </p>

  <p>

    Please notice: <a href="2014/01/30/public-voit-beta/">The software building this site is under constant development</a>. See
...
#+BEGIN_EXPORT HTML
    ...
    <footer>
      <p><i>[[id:2014-03-09-about][#BLOG-NAME#]]</i> is authored in <a href="//orgmode.org">Org-mode</a> and generated by <a href="https://github.com/novoid/lazyblorg">lazyblorg</a>
  ...
  <body>
	...
	<header>
	  ...
	  <nav class="persistent-article-header-nav">
	    <span class="breadcrumbs">
	      <a href="../"><img src="#BASE-URL#/images/public-voit_logo.svg" alt="#BLOG-NAME# logo" width="350" style="vertical-align:middle;"></a>
	    </span>
	  </nav>
  ...
  <body>
	...
	<header>
	  ...
	  <nav class="temporal-article-header-nav">
	    <span class="breadcrumbs">
	      <a href="../../../../"><img src="#BASE-URL#/images/public-voit_logo.svg" alt="#BLOG-NAME# logo" width="350" style="vertical-align:middle;"></a><span style="padding-top:1em;">&nbsp;&nbsp;&nbsp;&nbsp;&raquo;
  ...
  <article class="month-overview">
	...
	<header>
	  ...
	  <nav class="month-overview-header-nav">
	    <span class="breadcrumbs">
	      <a href="../../"><img src="//karl-voit.at/images/public-voit_logo.svg" alt="#BLOG-NAME# logo" width="350" style="vertical-align:middle;"></a><span style="padding-top:1em;">&nbsp;&nbsp;&nbsp;&nbsp;&raquo;
