...
blog entry in general, by the way.)q
...
Some templates have language-specific variants, selected automatically
based on the entry's detected language (via stopword analysis or a
manual language user-tag like ~:deutsch:~). Language variants use a
two-letter suffix: ~-en~ for English, ~-de~ for German.

Currently language-specific:
- ~comment-line-en~ / ~comment-line-de~ :: The comment section shown
  below articles with links to Mastodon, email, and Disqus.
- ~mastodon-comment-text-en~ / ~mastodon-comment-text-de~ :: The
  pre-filled text for commenting on an article via Mastodon.

English (~-en~) is the fallback: if a language variant is missing,
lazyblorg logs a warning and uses the English template instead.

*** Adding a new language

To add support for a new language (e.g., French):

1. Add stopwords for the language to ~Utils.STOPWORDS~ in
   ~lib/utils.py~. The first element of each tuple is the language
   name (e.g., ~'français'~), the second is a list of stopwords.

2. Add the language mapping to ~_get_entry_language_suffix()~ in
   ~lib/htmlizer.py~. The ~lang_map~ dict maps the language name (as
   used in stopwords/autotags) to a two-letter suffix:
   : lang_map = {'deutsch': 'de', 'english': 'en', 'français': 'fr'}

3. Add template variants in this file with the new suffix:
   - ~#+NAME: comment-line-fr~ :: French comment line
   - ~#+NAME: mastodon-comment-text-fr~ :: French Mastodon comment text

4. If you use ~CLUE_TEXT_FOR_LINKED_IMAGES~ in ~config.py~, add the
...
Contains the full ~<aside class="published-on">~ bar with publication date on
the left and the Mastodon share button on the right (via ~#SHARE-ON-MASTODON-BUTTON#~).
Used in footer templates via the ~#PUBLISHED-ON#~ placeholder.

#+NAME: published-on
#+BEGIN_EXPORT HTML
	  <aside class="published-on">
	    <span>Published on <time datetime="#ARTICLE-PUBLISHED-HTML-DATETIME#">#ARTICLE-PUBLISHED-HUMAN-READABLE#</time></span>
...
Contains ~<div id="disqus_thread">~, the lazy-load button/script block, and the
~<noscript>~ fallback — identical across all footer templates.
Used via the ~#DISQUS-SNIPPET#~ placeholder.
...
Used in footer templates via the ~#SHARE-ON-MASTODON-BUTTON#~ placeholder.
Contains the share link with SVG logo, pre-formatted share text (title, URL,
hashtag), and proper URL encoding. Relies on:
- #ARTICLE-TITLE-URL-ENCODED#: URL-encoded article title (no HTML entities)
- #ARTICLE-FULL-URL-ENCODED#: fully URL-encoded https://domain/path/ URL
- #BLOG-HASH-TAG#: blog hashtag without leading # (from config BLOG_HASH_TAG)
- #ARTICLE-HASH-TAG#: article-specific hashtag without leading # (sanitized from title)

#+NAME: share-on-mastodon-button
#+BEGIN_EXPORT HTML
<a href="https://share.joinmastodon.org/?text=%22#ARTICLE-TITLE-URL-ENCODED#%22%0A#ARTICLE-FULL-URL-ENCODED#%0A%23#BLOG-HASH-TAG#%20%23#ARTICLE-HASH-TAG#" target="_blank" rel="noopener" class="share-mastodon">Share on <svg height="1em" role="img" aria-label="Mastodon" viewBox="0 0 74 79" fill="currentColor" xmlns="http://www.w3.org/2000/svg"><path d="M73.7014 17.4323C72.5616 9.05152 65.1774 2.4469 56.424 1.1671C54.9472 0.950843 49.3518 0.163818 36.3901 0.163818H36.2933C23.3281 0.163818 20.5465 0.950843 19.0697 1.1671C10.56 2.41145 2.78877 8.34604 0.903306 16.826C-0.00357854 21.0022 -0.100361 25.6322 0.068112 29.8793C0.308275 35.9699 0.354874 42.0498 0.91406 48.1156C1.30064 52.1448 1.97502 56.1419 2.93215 60.0769C4.72441 67.3445 11.9795 73.3925 19.0876 75.86C26.6979 78.4332 34.8821 78.8603 42.724 77.0937C43.5866 76.8952 44.4398 76.6647 45.2833 76.4024C47.1867 75.8033 49.4199 75.1332 51.0616 73.9562C51.0841 73.9397 51.1026 73.9184 51.1156 73.8938C51.1286 73.8693 51.1359 73.8421 51.1368 73.8144V67.9366C51.1364 67.9107 51.1302 67.8852 51.1186 67.862C51.1069 67.8388 51.0902 67.8184 51.0695 67.8025C51.0489 67.7865 51.0249 67.7753 50.9994 67.7696C50.9738 67.764 50.9473 67.7641 50.9218 67.7699C45.8976 68.9569 40.7491 69.5519 35.5836 69.5425C26.694 69.5425 24.3031 65.3699 23.6184 63.6327C23.0681 62.1314 22.7186 60.5654 22.5789 58.9744C22.5775 58.9477 22.5825 58.921 22.5934 58.8965C22.6043 58.8721 22.621 58.8505 22.6419 58.8336C22.6629 58.8167 22.6876 58.8049 22.714 58.7992C22.7404 58.7934 22.7678 58.794 22.794 58.8007C27.7345 59.9796 32.799 60.5746 37.8813 60.5733C39.1036 60.5733 40.3223 60.5733 41.5447 60.5414C46.6562 60.3996 52.0437 60.1408 57.0728 59.1694C57.1983 59.1446 57.3237 59.1233 57.4313 59.0914C65.3638 57.5847 72.9128 52.8555 73.6799 40.8799C73.7086 40.4084 73.7803 35.9415 73.7803 35.4523C73.7839 33.7896 74.3216 23.6576 73.7014 17.4323ZM61.4925 47.3144H53.1514V27.107C53.1514 22.8528 51.3591 20.6832 47.7136 20.6832C43.7061 20.6832 41.6988 23.2499 41.6988 28.3194V39.3803H33.4078V28.3194C33.4078 23.2499 31.3969 20.6832 27.3894 20.6832C23.7654 20.6832 21.9552 22.8528 21.9516 27.107V47.3144H13.6176V26.4937C13.6176 22.2395 14.7157 18.8598 16.9118 16.3545C19.1772 13.8552 22.1488 12.5719 25.8373 12.5719C30.1064 12.5719 33.3325 14.1955 35.4832 17.4394L37.5587 20.8853L39.6377 17.4394C41.7884 14.1955 45.0145 12.5719 49.2765 12.5719C52.9614 12.5719 55.9329 13.8552 58.2055 16.3545C60.4017 18.8574 61.4997 22.2371 61.4997 26.4937L61.4925 47.3144Z" fill="inherit"></path></svg></a>
#+END_EXPORT

*** Mastodon footer entry

Used in footer templates via the ~#MASTODON-FOOTER-ENTRY#~ placeholder.
Expanded to the Mastodon profile link when ~MASTODON_USER_URL~ is set in
~config.py~, or to an empty string otherwise.

#+NAME: mastodon-footer-entry
#+BEGIN_EXPORT HTML
	 	&nbsp;&bull;&nbsp; <a rel="me" href="#MASTODON_USER_URL#"><svg height="1em" role="img" aria-label="Mastodon" viewBox="0 0 74 79" fill="currentColor" xmlns="http://www.w3.org/2000/svg"><path d="M73.7014 17.4323C72.5616 9.05152 65.1774 2.4469 56.424 1.1671C54.9472 0.950843 49.3518 0.163818 36.3901 0.163818H36.2933C23.3281 0.163818 20.5465 0.950843 19.0697 1.1671C10.56 2.41145 2.78877 8.34604 0.903306 16.826C-0.00357854 21.0022 -0.100361 25.6322 0.068112 29.8793C0.308275 35.9699 0.354874 42.0498 0.91406 48.1156C1.30064 52.1448 1.97502 56.1419 2.93215 60.0769C4.72441 67.3445 11.9795 73.3925 19.0876 75.86C26.6979 78.4332 34.8821 78.8603 42.724 77.0937C43.5866 76.8952 44.4398 76.6647 45.2833 76.4024C47.1867 75.8033 49.4199 75.1332 51.0616 73.9562C51.0841 73.9397 51.1026 73.9184 51.1156 73.8938C51.1286 73.8693 51.1359 73.8421 51.1368 73.8144V67.9366C51.1364 67.9107 51.1302 67.8852 51.1186 67.862C51.1069 67.8388 51.0902 67.8184 51.0695 67.8025C51.0489 67.7865 51.0249 67.7753 50.9994 67.7696C50.9738 67.764 50.9473 67.7641 50.9218 67.7699C45.8976 68.9569 40.7491 69.5519 35.5836 69.5425C26.694 69.5425 24.3031 65.3699 23.6184 63.6327C23.0681 62.1314 22.7186 60.5654 22.5789 58.9744C22.5775 58.9477 22.5825 58.921 22.5934 58.8965C22.6043 58.8721 22.621 58.8505 22.6419 58.8336C22.6629 58.8167 22.6876 58.8049 22.714 58.7992C22.7404 58.7934 22.7678 58.794 22.794 58.8007C27.7345 59.9796 32.799 60.5746 37.8813 60.5733C39.1036 60.5733 40.3223 60.5733 41.5447 60.5414C46.6562 60.3996 52.0437 60.1408 57.0728 59.1694C57.1983 59.1446 57.3237 59.1233 57.4313 59.0914C65.3638 57.5847 72.9128 52.8555 73.6799 40.8799C73.7086 40.4084 73.7803 35.9415 73.7803 35.4523C73.7839 33.7896 74.3216 23.6576 73.7014 17.4323ZM61.4925 47.3144H53.1514V27.107C53.1514 22.8528 51.3591 20.6832 47.7136 20.6832C43.7061 20.6832 41.6988 23.2499 41.6988 28.3194V39.3803H33.4078V28.3194C33.4078 23.2499 31.3969 20.6832 27.3894 20.6832C23.7654 20.6832 21.9552 22.8528 21.9516 27.107V47.3144H13.6176V26.4937C13.6176 22.2395 14.7157 18.8598 16.9118 16.3545C19.1772 13.8552 22.1488 12.5719 25.8373 12.5719C30.1064 12.5719 33.3325 14.1955 35.4832 17.4394L37.5587 20.8853L39.6377 17.4394C41.7884 14.1955 45.0145 12.5719 49.2765 12.5719C52.9614 12.5719 55.9329 13.8552 58.2055 16.3545C60.4017 18.8574 61.4997 22.2371 61.4997 26.4937L61.4925 47.3144Z" fill="inherit"></path></svg></a>
#+END_EXPORT

*** Mastodon logo SVG

The Mastodon logo SVG used across multiple templates to reduce redundancy.
Referenced via the ~#MASTODON-LOGO-SVG#~ internal placeholder (not a
user-facing template variable).

#+NAME: mastodon-logo-svg
#+BEGIN_EXPORT HTML
<svg height="1em" role="img" aria-label="Mastodon" viewBox="0 0 74 79" fill="currentColor" xmlns="http://www.w3.org/2000/svg"><path d="M73.7014 17.4323C72.5616 9.05152 65.1774 2.4469 56.424 1.1671C54.9472 0.950843 49.3518 0.163818 36.3901 0.163818H36.2933C23.3281 0.163818 20.5465 0.950843 19.0697 1.1671C10.56 2.41145 2.78877 8.34604 0.903306 16.826C-0.00357854 21.0022 -0.100361 25.6322 0.068112 29.8793C0.308275 35.9699 0.354874 42.0498 0.91406 48.1156C1.30064 52.1448 1.97502 56.1419 2.93215 60.0769C4.72441 67.3445 11.9795 73.3925 19.0876 75.86C26.6979 78.4332 34.8821 78.8603 42.724 77.0937C43.5866 76.8952 44.4398 76.6647 45.2833 76.4024C47.1867 75.8033 49.4199 75.1332 51.0616 73.9562C51.0841 73.9397 51.1026 73.9184 51.1156 73.8938C51.1286 73.8693 51.1359 73.8421 51.1368 73.8144V67.9366C51.1364 67.9107 51.1302 67.8852 51.1186 67.862C51.1069 67.8388 51.0902 67.8184 51.0695 67.8025C51.0489 67.7865 51.0249 67.7753 50.9994 67.7696C50.9738 67.764 50.9473 67.7641 50.9218 67.7699C45.8976 68.9569 40.7491 69.5519 35.5836 69.5425C26.694 69.5425 24.3031 65.3699 23.6184 63.6327C23.0681 62.1314 22.7186 60.5654 22.5789 58.9744C22.5775 58.9477 22.5825 58.921 22.5934 58.8965C22.6043 58.8721 22.621 58.8505 22.6419 58.8336C22.6629 58.8167 22.6876 58.8049 22.714 58.7992C22.7404 58.7934 22.7678 58.794 22.794 58.8007C27.7345 59.9796 32.799 60.5746 37.8813 60.5733C39.1036 60.5733 40.3223 60.5733 41.5447 60.5414C46.6562 60.3996 52.0437 60.1408 57.0728 59.1694C57.1983 59.1446 57.3237 59.1233 57.4313 59.0914C65.3638 57.5847 72.9128 52.8555 73.6799 40.8799C73.7086 40.4084 73.7803 35.9415 73.7803 35.4523C73.7839 33.7896 74.3216 23.6576 73.7014 17.4323ZM61.4925 47.3144H53.1514V27.107C53.1514 22.8528 51.3591 20.6832 47.7136 20.6832C43.7061 20.6832 41.6988 23.2499 41.6988 28.3194V39.3803H33.4078V28.3194C33.4078 23.2499 31.3969 20.6832 27.3894 20.6832C23.7654 20.6832 21.9552 22.8528 21.9516 27.107V47.3144H13.6176V26.4937C13.6176 22.2395 14.7157 18.8598 16.9118 16.3545C19.1772 13.8552 22.1488 12.5719 25.8373 12.5719C30.1064 12.5719 33.3325 14.1955 35.4832 17.4394L37.5587 20.8853L39.6377 17.4394C41.7884 14.1955 45.0145 12.5719 49.2765 12.5719C52.9614 12.5719 55.9329 13.8552 58.2055 16.3545C60.4017 18.8574 61.4997 22.2371 61.4997 26.4937L61.4925 47.3144Z" fill="inherit"></path></svg>
#+END_EXPORT

*** Mastodon comment text (English)

The pre-filled text for commenting on an article via Mastodon (English version).
The user is expected to replace ~FIXXME~ with their actual comment.

- ~#BLOG-HASH-TAG#~: the blog's hashtag (from config, without leading #)
- ~#ARTICLE-TITLE#~: the article title
- ~#ARTICLE-URL#~: the full URL of the article
- ~#ARTICLE-HASH-TAG#~: the article-specific hashtag (with leading #)

#+NAME: mastodon-comment-text-en
#+BEGIN_EXPORT HTML
Comment on the #BLOG-HASH-TAG# article: #ARTICLE-TITLE#
#ARTICLE-URL#

#ARTICLE-HASH-TAG#
#+END_EXPORT

*** Mastodon comment text (German)

The pre-filled text for commenting on an article via Mastodon (German version).

#+NAME: mastodon-comment-text-de
#+BEGIN_EXPORT HTML
Kommentar zum #BLOG-HASH-TAG# Blogartikel: #ARTICLE-TITLE#
#ARTICLE-URL#

#ARTICLE-HASH-TAG#
#+END_EXPORT

*** Comment line (English)

The comment line shown below articles with links to Mastodon, email, and Disqus.
Used via the ~#COMMENT-LINE#~ placeholder in footer templates.

- ~#COMMENT-MASTODON-URL#~: the full share.joinmastodon.org URL with pre-filled comment text
- ~#MASTODON-LOGO-SVG#~: the inline Mastodon SVG logo
- ~#ARTICLE-HASH-TAG#~: the article-specific hashtag (without leading #)
- ~#COMMENT-EMAIL-ADDRESS#~: email address for comments
- ~#ARTICLE-ID#~: the article ID (used in email subject)

#+NAME: comment-line-en
#+BEGIN_EXPORT HTML
   <p class="email-comment">
      <a href="#COMMENT-MASTODON-URL#" target="_blank" rel="noopener" class="comment-mastodon">Comment via #MASTODON-LOGO-SVG#</a> using the hashtag <code class="comment-hashtag">##ARTICLE-HASH-TAG#</code> (decentralized), <a href="mailto:#COMMENT-EMAIL-ADDRESS#?subject=#ARTICLE-ID#%20comment:%20&body=Please%20do%20not%20remove%20'#ARTICLE-ID#%20comment:'%20in%20subject%20and%20please%20tell%20me%20whether%20or%20not%20it%20is%20OK%20to%20add%20your%20comment%20and%2For%20your%20name%20and%2For%20your%20email%20address%20to%20the%20blog%20entry!">email</a> (persistent) or via <a href="//disqus.com">Disqus</a> (ephemeral) comments below:
   </p>
#+END_EXPORT

*** Comment line (German)

#+NAME: comment-line-de
#+BEGIN_EXPORT HTML
   <p class="email-comment">
      <a href="#COMMENT-MASTODON-URL#" target="_blank" rel="noopener" class="comment-mastodon">Kommentiere via #MASTODON-LOGO-SVG#</a> unter dem Hashtag <code class="comment-hashtag">##ARTICLE-HASH-TAG#</code> (verteilt), via <a href="mailto:#COMMENT-EMAIL-ADDRESS#?subject=#ARTICLE-ID#%20comment:%20&body=Please%20do%20not%20remove%20'#ARTICLE-ID#%20comment:'%20in%20subject%20and%20please%20tell%20me%20whether%20or%20not%20it%20is%20OK%20to%20add%20your%20comment%20and%2For%20your%20name%20and%2For%20your%20email%20address%20to%20the%20blog%20entry!">E-Mail</a> (langlebig) oder mittels <a href="//disqus.com">Disqus</a> (kurzlebig) hier drunter:
   </p>
#+END_EXPORT

*** Comment line (hidden entries)

For entries tagged with ~hidden~: no Mastodon comment link, just email and Disqus.

#+NAME: comment-line-hidden
#+BEGIN_EXPORT HTML
   <p class="email-comment">
...
#+BEGIN_EXPORT HTML
  ...
  <p>
    ...
    This is the homepage of [[id:#ABOUT-PAGE-ID#][#AUTHOR-NAME#]].
  ...
  <p>
    ...
    My recommendations are <a href="tags/pim/">pim</a>, <a href="tags/privacy/">privacy</a>, <a href="tags/security/">security</a> and of course <a href="tags/populararticles/">populararticles</a>.
...
#+BEGIN_EXPORT HTML
    ...
    <footer>
      <p><i>[[id:#ABOUT-PAGE-ID#][#BLOG-NAME#]]</i> is authored in <a href="//orgmode.org">Org mode</a> and generated by <a href="https://github.com/novoid/lazyblorg">lazyblorg</a>
	 	...
	 	&nbsp;&bull;&nbsp; <a href="https://creativecommons.org/licenses/by/4.0/">CC BY 4.0</a>
...
#+BEGIN_EXPORT HTML
  ...
  <link rel="alternate" type="application/atom+xml"
        title="#BLOG-NAME# (full content)" href="#FEEDURL_CONTENT#" />
  <link rel="alternate" type="application/atom+xml"
        title="#BLOG-NAME# – tag: #ARTICLE-TITLE# (full content)" href="#TAG-FEED-URL#" />
...
#+BEGIN_EXPORT HTML
  ...
  <p>
  <img src="#BASE-URL#/images/feed-icon-14x14.png" alt="RSS icon" />&nbsp;Subscribe to the <a href="#TAG-FEED-URL#">Atom feed for the tag #ARTICLE-TITLE#</a> (<a href="#BASE-URL#/how-to-use-public-voit/">What is a feed?</a>).
  </p>
...
Pages for drilling down by multiple tags. Generated automatically
for all combinations of co-occurring tags.

- #TAGTREE-BREADCRUMB#: breadcrumb navigation for the tag path
- #TAGTREE-DRILLDOWN#: drill-down section with tag cloud (omitted at max depth)
- #TAGTREE-ARTICLE-LIST#: list of matching articles
- #TAGTREE-TAG-LIST#: comma-separated list of tags in this branch
- #COMMON-SIDEBAR# : the sidebar content which is shared on all pages

*** TagTree Feed Info

#+NAME: tagtree-feed-info
#+BEGIN_EXPORT HTML

  <p>
  <img src="#BASE-URL#/images/feed-icon-14x14.png" alt="RSS icon" />&nbsp;Subscribe to the <a href="#TAGTREE-FEED-URL#">Atom feed for the tags #TAGTREE-TAG-LIST#</a> (<a href="#BASE-URL#/how-to-use-public-voit/">What is a feed?</a>).
  </p>
...
#+BEGIN_EXPORT HTML
  ...
  <link rel="stylesheet" title="#BLOG-NAME# Standard CSS Style"
        href="#CSS-URL#" type="text/css" media="screen"  />
  <link rel="alternate" type="application/atom+xml"
        title="#BLOG-NAME# Atom 1.0 links only"
        href="#FEEDURL_LINKS#" />
  <link rel="alternate" type="application/atom+xml"
        title="#BLOG-NAME# Atom 1.0 articles with teaser"
        href="#FEEDURL_TEASER#" />
  <link rel="alternate" type="application/atom+xml"
        title="#BLOG-NAME# Atom 1.0 articles with full content"
        href="#FEEDURL_CONTENT#" />
#TAGTREE-FEED-LINK#
  <title>Tags: #TAGTREE-TAG-LIST# – #BLOG-NAME#</title>
  </head>
  <body>
    ...
    <div id="main" class="wrapper">
	  ...
	  <nav class="temporal-article-header-nav">
	    <span class="breadcrumbs">
	      <a href="#BASE-URL#/"><img src="#BLOG-LOGO#" alt="#BLOG-NAME# logo" width="350" style="vertical-align:middle;"></a><span style="padding-top:1em;">&nbsp;&nbsp;&nbsp;&nbsp;&raquo;#TAGTREE-BREADCRUMB#</span>
	    </span>
	  </nav>
  ...
  <h1 class="common-article-header-title">Articles tagged with #TAGTREE-TAG-LIST#</h1>

#TAGTREE-FEED-INFO#
#TAGTREE-DRILLDOWN#
  <p>
  All articles tagged with #TAGTREE-TAG-LIST# <span class="minor-contrast">(sorted by last update, oldest on top)</span>:
  </p>

  <p>
  #TAGTREE-ARTICLE-LIST#
  </p>
...
- #DAY-TWODIGITNUMBER#: number of the day like "01" or "30"
- #COMMON-SIDEBAR# : the sidebar content which is shared on all pages
...
#+BEGIN_EXPORT HTML
  ...
  <title>#BLOG-NAME#: #YEAR#-#MONTH-TWODIGITNUMBER#-#DAY-TWODIGITNUMBER#</title>
  </head>
  ...
  <body>
	...
	<header>
	  ...
	  <nav class="temporal-article-header-nav">
	    <span class="breadcrumbs">
	      <a href="../../../"><img src="#BLOG-LOGO#" alt="#BLOG-NAME# logo" width="350" style="vertical-align:middle;"></a><span style="padding-top:1em;">&nbsp;&nbsp;&nbsp;&nbsp;&raquo;
	      <a href="../../">#YEAR#</a>&nbsp;&ndash;&nbsp;<a href="../">#MONTH-TWODIGITNUMBER#</a>&nbsp;&ndash;&nbsp;#DAY-TWODIGITNUMBER#</span>
	    </span>
	  </nav>

	  <h1 class="article-title">#YEAR#-#MONTH-TWODIGITNUMBER#-#DAY-TWODIGITNUMBER#</h1>
...
#+BEGIN_EXPORT HTML
  ...
  <title>#BLOG-NAME#: #YEAR#-#MONTH-TWODIGITNUMBER#</title>
  </head>
  ...
  <body>
	...
	<header>
	  ...
	  <nav class="temporal-article-header-nav">
	    <span class="breadcrumbs">
	      <a href="../../"><img src="#BLOG-LOGO#" alt="#BLOG-NAME# logo" width="350" style="vertical-align:middle;"></a><span style="padding-top:1em;">&nbsp;&nbsp;&nbsp;&nbsp;&raquo;
	      <a href="../">#YEAR#</a>&nbsp;&ndash;&nbsp;#MONTH-TWODIGITNUMBER#</span>
	    </span>
	  </nav>
...
#+BEGIN_EXPORT HTML
  ...
  <article class="year-overview">

  <p><ul class="year-body">
