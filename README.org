## Time-stamp: <2014-01-31 20:44:03 vk>
## -*- coding: utf-8 -*-
...
1. Get the source
2. do a test-drive with ~example_invocation.sh~
   - this should work
...
7. adopt the blog template in ~[[https://github.com/novoid/lazyblorg/blob/master/templates/blog-format.org][templates/blog-format.org]]~
