...
variables used for the shell scripts and pytest invocation.
...
- As lazyblorg is a works-for-me project, *I'm not going to implement
  any feature I would not use myself*. Feel free and fork this project
  if you do have different requirements you would like to see
  implemented.
...
- [[https://github.com/novoid/lazyblorg/wiki/Snippets][Snippets]]: Define reusable content fragments as Org-mode entries
  and reference them from any blog article using =[[id:snippet-id]]=
  syntax. Supports inline and block replacement, heading level
  adaptation, and nesting.
...
- With the command line parameter =--external-url-file= you can
  generate a TSV file listing all external URLs found across your blog
