...
# Time-stamp: <2014-02-02 17:12:33 vk>
...
** pre-formatted blocks: VERSE
:PROPERTIES:
:CREATED:  [2014-01-30 Thu 15:54]
:END:

#+BEGIN_VERSE
This is verse without any title.
  Second line.

     Last line.
#+END_VERSE

#+NAME: This is the title/name of the verse block
#+BEGIN_VERSE
This is verse with a title.
  Second line.
...
** QUOTE-blocks
:PROPERTIES:
:CREATED:  [2014-01-30 Thu 16:06]
:END:

#+BEGIN_QUOTE
Das ist ein tolles Zitat von irgendeiner Quelle mit tollen Dingen wie
URLs von Seiten wie http://heise.de oder anderen netten Sachen wie
Listen, was hier aber noch recht gemein ist:

- Das ist ein Listenelement
- Das ist die zweite Zeile der Liste
  - hier ist verschachtelte auch noch
- hier wieder nicht
